...
/**
 * <p>
 * A stateless implementation of the TicketService that delegates seat holds
 * to a persistence store for state management.
 * </p>
 */
public class StatelessDurableTicketService implements DurableTicketService {
  ...
  private static Logger logger = Logger.getLogger(StatelessDurableTicketService.class);
